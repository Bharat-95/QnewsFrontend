          ...
          {data
            ...
            .map((latest) => (
              <Link
                ...
                key={latest.newsId}
                className="flex-shrink-0 w-[80%] md:w-[40%] lg:w-[30%] border border-black lg:p-3 md:p-2 p-2 rounded-md shadow-lg space-y-2 hover:transform duration-500 hover:translate-x-2 hover:-translate-y-2"
              >
                <Image
                  alt="No Image Found"
                  src={latest.image}
